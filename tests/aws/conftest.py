...
def sqs_sns_event_dict():
    return {
        ...
        "TopicArn": "arn:aws:sns:us-east-1:086285707022:pCloud-tenant-orchestrator-nadir-test-tenantTopic.fifo",
        "Message": "",
        "Timestamp": "2021-02-17T09:54:00.108Z",
        "UnsubscribeURL": "https://sns.us-east-1.amazonaws.com/?Action=Unsubscribe&SubscriptionArn=arn:aws:sns:us-east-1:086285707022:pCloud-tenant-orchestrator-nadir-test-tenantTopic.fifo:da1e7c83-7690-49f7-aa28-f5da3ad3c3fd",
        "MessageAttributes": {
            "signature": {"Type": "Binary",
                          "Value": "MIGHAkIBZ1oRAWCoLY53OAYTo8hi+zDTeUEMD/1pyxPjQ5NuRS2cqSk1U5vvpJYvlCSrubbYbX1d\r\nrK7j2K6mYuja9mWRwz0CQT+PbWoi+RsaX5eUWJRkZSia+QEr16sSUFXLh15uxZEHPI/6mc96mbXo\r\ndQHZGZ4vN6N3lPHpWbMaH6hOoL2JRs2A\r\n"}
        }
    }
...
def api_gw_event_dict_with_base64():
    return {
        'resource': '/files/v1/installCertificate/{customerId}',
        'path': '/files/v1/installCertificate/009530a5-e51e-4574-a795-39a33f210ac4',
        'httpMethod': 'POST',
        'headers': {
        ...
        'multiValueHeaders': {
            ...
            'X-Amzn-Trace-Id': ['Root=1-602c57ba-7d2074e51d075f6d2395a205'],
            'X-CORRELATION-ID': ['c6a531cd-01fa-44af-8d41-5c994b46a91b'],
            'X-Forwarded-For': ['31.168.4.18'], 'X-Forwarded-Port': ['443'],
        ...
        'requestContext': {
            ...
            'resourcePath': '/files/v1/installCertificate/{customerId}',
            'httpMethod': 'POST',
            ...
            'domainName': 'master.pcloudconsole.com',
            'apiId': 'vxv7hbixe4'
        },
